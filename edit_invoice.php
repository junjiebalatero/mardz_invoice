...
?>
<title>Mardz | Invoice System</title>
	    	...
	    	<div class="load-animate animated fadeInUp">
		    	<div class="row">
		    		<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
		    			<h1 class="title">Mardz Invoice System</h1>
						<?php include('menu.php');?>			
		    		</div>		    		
		    	</div>
		      	<input id="currency" type="hidden" value="php">
		    	<div class="row">
						...
						<span class="form-inline">
							<div class="form-group">
								...
								<div class="input-group">
									<div class="input-group-addon currency">php</div>
